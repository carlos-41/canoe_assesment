...
class FundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fund" do
    assert_difference("Fund.count") do
      post funds_url, params: { fund: { aliases: @fund.aliases, name: @fund.name, start_year: @fund.start_year } }
    end
  ...
  test "should update fund" do
    patch fund_url(@fund), params: { fund: { aliases: @fund.aliases, name: @fund.name, start_year: @fund.start_year } }
